...
Pitch deck de 12 slides + 1 annexe en français, destiné au comité de
...
4. Le produit — AI Exit Test → rapport (qualité, coût, latence, effort, résidence, verdict)
5. Pourquoi maintenant — DORA (art. 28 : sorties « suffisamment testées ») + tailwinds AI Act / souveraineté
6. Concurrence — gateways, evals/observabilité, GRC, cloud exit : personne ne prouve la substituabilité
7. Business model — LAND : AI Exit Test 3-10 k€ → EXPAND : Continuous Exit Assurance 15-30 k€ ARR
8. Go-to-market — déclenché par les événements (RFP, revue DORA/TPRM, disruption modèle/prix)
9. Validation — preuve technologique vs validation commerciale (honnête : 0 client payant)
10. Économie & ambition — trajectoire jusqu'à 500 clients × 20 k€ = 10 M€ ARR
11. Équipe
12. Pourquoi Innovact — ce que l'incubation débloque
...
node verify-overflow.mjs   # vérifier l'absence de débordement sur les 13 slides (nécessite un build)
```
